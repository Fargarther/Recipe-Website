...
`;
if (!document.head.querySelector('style[data-pinned-shake]')) {
  style.setAttribute('data-pinned-shake', 'true');
...
function Spotlight() {
  ...
  const handleClear = () => {
    console.log('Clear Board clicked'); // Debug log
    ...
    console.log('decorationsRef.current:', decorationsRef.current); // Debug log
    if (decorationsRef.current) {
      console.log('Calling clearAll on decorations'); // Debug log
      decorationsRef.current.clearAll();
    } else {
      console.log('decorationsRef.current is null'); // Debug log
    }
  };
