...
export const CardContainer = styled.div`
  ...
  width: 250px; 
  height: 150px;
  transform: ${props => `rotate(${props.rotate}deg) translate(${props.translateX}px, ${props.translateY}px)`};
  transform-origin: center center;
  transition: ${props => props.isDragging ? 'none' : 'transform 0.3s, box-shadow 0.3s'};
